...
1. install dependencies, cmake and libmpdclient are available from all major distributions.  Openssl and openssl development options should also be installed.
